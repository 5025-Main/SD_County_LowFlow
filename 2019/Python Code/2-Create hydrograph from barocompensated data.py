...
### UPDATE HERE #####
start, end = dt.datetime(2019,5,1,0,0), dt.datetime(2019,9,17,23,59)
...
# MANUAL DATA OFFSETS TO GET SERIES TO LINE 
    ...
    offsets = pd.read_excel(hydrograph_fileoutput_dir+'clips and offsets/Offsets and Clip times '+data_processing_date+'_FINAL.xlsx',sheetname='Offsets',index_col=0,parse_cols='A:G')
...
# MANUAL CLIPS OF BAD DATA/STORMFLOW  
    clips = pd.read_excel(hydrograph_fileoutput_dir+'clips and offsets/Offsets and Clip times '+data_processing_date+'_FINAL.xlsx',sheetname='Clips',index_col=0,parse_cols='A:F')   
...
## Kick out to Excel
final_flow_ExcelFile = pd.ExcelWriter(hydrograph_fileoutput_dir+site_name+'-working draft_v2.xlsx')
