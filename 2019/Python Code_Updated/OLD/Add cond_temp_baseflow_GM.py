...
localdir = 'C:/Users/garrett.mcgurk/Desktop/CountyWeirProcessing/'
...
#%%
    ...
    del_df = del_df.reindex(index=pd.date_range(start,end,freq='5Min')).interpolate(method='linear',limit=2)
    del_df.round(3).to_excel(output_dir + site_name + ' - flow w Cond Temp and baseflow.xlsx')
    
####   reindex temp and cond data to 5min w/ linear interpolation    #####
     #From hydrograph script
